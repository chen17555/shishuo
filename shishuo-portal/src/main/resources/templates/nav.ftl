<nav class="navbar navbar-inverse">
    <div class="container">
        <div class="navbar-header">
            <a class="navbar-brand">师说</a>
        </div>
        <div id="navbar" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                <li class="<#if session_nav=="wenda">active</#if>"><a href="${request.contextPath}/wenda">问答</a></li>
                <li class="<#if session_nav=="blog">active</#if>"><a href="${request.contextPath}/blog">博客</a></li>
                <li class="<#if session_nav=="notice">active</#if>"><a href="${request.contextPath}/notice">通知</a></li>
            </ul>
