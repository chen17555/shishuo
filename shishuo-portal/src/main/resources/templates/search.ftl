...
<div id="main">
    <div class="search-main">
        <div class="search-header">
            ...
            <ul class="search-hot">
                <li><a href="${request.contextPath}/search/?words=AngularJS" target="_blank">AngularJS</a></li>
                <li><a href="${request.contextPath}/search/?words=mysql" target="_blank">mysql</a></li>
                <li><a href="${request.contextPath}/search/?words=java" target="_blank">java</a></li>
                <li><a href="${request.contextPath}/search/?words=android" target="_blank">android</a></li>
                <li><a href="${request.contextPath}/search/?words=C" target="_blank">C</a></li>
                <li><a href="${request.contextPath}/search/?words=php" target="_blank">php</a></li>
                <li><a href="${request.contextPath}/search/?words=javascript" target="_blank">javascript</a></li>
                <li><a href="${request.contextPath}/search/?words=ajax" target="_blank">ajax</a></li>
            </ul>
        </div>
