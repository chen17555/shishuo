...
<head>
    ...
    <link rel="stylesheet" href="${request.contextPath}/static/css/question-tag.css" />
</head>
<body>
    <#include "../nav.ftl">
    ...
    <div class="container main" style="margin-top: 42px">
        <div class="row wenda">
            <div class="col-lg-8 wenda-main">
                <div class="row nb">
                    <ul class="nav navbar-nav">
                        <#if questionPage??>
                            ...
                            <li><a href="/wenda/tag/${tagInfo.tagId}/recommend/1" class="active">推荐</a></li>
                            <li><a href="/wenda/tag/${tagInfo.tagId}/new/1">最新</a></li>
                            <li><a href="/wenda/tag/${tagInfo.tagId}/waitreply/1">等待回答</a></li>
                            <#elseif  questionPage == "new">
                            <li><a href="/wenda/tag/${tagInfo.tagId}/recommend/1" >推荐</a></li>
                            <li><a href="/wenda/tag/${tagInfo.tagId}/new/1" class="active">最新</a></li>
                            <li><a href="/wenda/tag/${tagInfo.tagId}/waitreply/1">等待回答</a></li>
                            <#else >
                            <li><a href="/wenda/tag/${tagInfo.tagId}/recommend/1" >推荐</a></li>
                            <li><a href="/wenda/tag/${tagInfo.tagId}/new/1" >最新</a></li>
                            <li><a href="/wenda/tag/${tagInfo.tagId}/waitreply/1" class="active">等待回答</a></li>
                            </#if>
                         <#else >
                            <li><a href="/wenda/tag/${tagInfo.tagId}/recommend/1" class="active">推荐</a></li>
                            <li><a href="/wenda/tag/${tagInfo.tagId}/new/1">最新</a></li>
                ...
                <div class="row page">
                    ...
                    <#else>
                    <a href="/wenda/tag/${tagInfo.tagId}/${questionPage}/1">首页</a>
                    <a href="/wenda/tag/${tagInfo.tagId}/${questionPage}/${pageInfo.prePage}">上一页</a>
                    </#if>
                                    <ul>
                        <#list pageInfo.navigateFirstPage..pageInfo.navigateLastPage as i>
                            ...
                            <#else >
                            <li><a class="text-page-tag" href="/wenda/tag/${tagInfo.tagId}/${questionPage}/${i}">${i}</a></li>
                            </#if>
                        </#list>
                                    </ul>
                    ...
                    <#else >
                    <a href="${request.contextPath}/wenda/tag/${tagInfo.tagId}/${questionPage}/${pageInfo.nextPage}">下一页</a>
                    <a href="${request.contextPath}/wenda/tag/${tagInfo.tagId}/${questionPage}/${pageInfo.pages}">尾页</a>
                    </#if>
                </div>
            </div>
