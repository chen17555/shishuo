...
import com.chenzhiheng.utils.ResourceUtil;
...
public class VerifitaionCodeController {
    ...
    public void VerificationCode( HttpServletRequest request,
        ...
        // 将认证码存入SESSION
        request.getSession().setAttribute(SessionBean.SESSION_KEY_OF_RAND_CODE, resultCode);
        // 图象生效
        graphics.dispose();
